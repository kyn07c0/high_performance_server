Основная цель указанных действий — предсказуемость и стабильность системы под максимальной нагрузкой.  
Жертвуя "пиковой" производительностью (отключая Turbo Boost) и гибкостью (прибивая процессы к ядрам) добиваемся того, чтобы в любой момент времени отклик системы был предсказуемым и не зависел от фоновых процессов, энергосберегающих функций ядра или конфликтов за ресурсы.

## 1. Настройка процессора и управления частотой

### Отключение энергосберегающих функций  
