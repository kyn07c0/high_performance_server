...
Жертвуя "пиковой" производительностью (отключая Turbo Boost) и гибкостью (прибивая процессы к ядрам) добиваемся того, чтобы в любой момент времени отклик системы был фиксированным и не зависел от фоновых процессов, энергосберегающих функций ядра или конфликтов за ресурсы.
